...
class RETrainer(BaseTrainer):
                ...
                for batch in self.train_data:
                    ...
                    if self.step % self.refresh_step == 0:
                        ...
                        if self.writer:
                            ...
                            self.writer.log({'train_loss':avg_loss, 'epoch':epoch})
                        avg_loss = 0
        ...
        with torch.no_grad():
            with tqdm(total=len(self.dev_data), leave=False, dynamic_ncols=True) as pbar:
                ...
                if self.writer:
                    ...
                    self.writer.log({'dev_acc':acc , 'dev_f1':micro_f1 , 'dev_loss':total_loss/len(self.test_data) , 'epoch':epoch})
        ...
        with torch.no_grad():
            with tqdm(total=len(self.test_data), leave=False, dynamic_ncols=True) as pbar:
                ...
                if self.writer:
                    ...
                    self.writer.log({'test_acc':acc, 'test_f1':micro_f1, 'test_loss':total_loss/len(self.test_data)})
    ...
    def before_train(self):
        ...
        self.optimizer = optim.Adadelta(optimizer_grouped_parameters, lr=self.args.lr)
